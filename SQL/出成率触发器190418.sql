...
from (select
rdrecord11.cDefine1 as 任务号,
CASE WHEN rdrecord11.cdefine9 IS NULL OR rdrecord11.cdefine9 ='' THEN 0 ELSE 100*(1-CAST(rdrecord11.cdefine9 as decimal(20,6))) END as 合理损耗上限,
CASE WHEN rdrecord11.cdefine2 IS NULL OR rdrecord11.cdefine2 ='' THEN 0 ELSE 100*(1-CAST(rdrecord11.cdefine2 as decimal(20,6))) END as 合理损耗下限
from rdrecords11
Left JOIN rdrecord11 ON rdrecords11.ID = rdrecord11.ID
